...
function showTutorial() {
  ...
  var steps = [
    ...
    { icon: '📷', t: 'Set Your Gear', tZh: '設定你的 Gear', d: 'Choose Camera, Lens, Film Stock, Lab, Developing Process, Push/Pull, and Scanner from the dropdowns. Custom entries are saved to your browser (localStorage) and show up next time.', dZh: '從下拉選單選擇相機、鏡頭、菲林、沖掃、沖洗方式、Push/Pull、掃描器。自訂輸入會儲存喺你嘅瀏覽器 (localStorage)，下次會自動出現。' },
    ...
    { icon: '📅', t: 'Set Date & Time', tZh: '設定攝影日期時間', d: 'Select one or more files, click "Set Date & Time". Each file automatically gets +1 minute added. Set up date segments if a roll spans multiple days.', dZh: '選擇一個或多個檔案，點擊「設定日期時間」。每張相會自動加 +1 分鐘。如果一卷菲林跨多天拍攝，可以設定多個日期段。' },
