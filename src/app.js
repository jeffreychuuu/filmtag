...
function showTutorial() {
  ...
  var guideSteps = [
    ...
    { icon: '☑️', t: 'Content Sheet', tZh: '索引樣片', d: 'Toggle "Include Content Sheet" ON in Review Summary to auto-generate a contact sheet JPEG in your ZIP or gallery. You can also download it standalone via "Download Content Sheet". It shows thumbnails, file numbers, and a footer with film, camera, lens, lab, and date range.', dZh: '喺 Review Summary toggle「包含索引樣片」，自動生成一張 contact sheet JPEG 加入 ZIP 或 gallery。你亦可以獨立按「下載索引樣片」。張 contact sheet 會顯示縮圖、編號、同 footer（菲林、相機、鏡頭、沖曬店、日期範圍）。' }
  ];
