...
function showTutorial() {
  ...
  var aboutSteps = [
    ...
    { icon: '⚙️', t: 'Custom Options', tZh: '自訂選項', d: 'The "Custom Options" button lets you manage all dropdown entries. Hide built-in presets you don\'t use, delete custom entries you\'ve added, or restore all defaults with one click. Changes save to your browser — dropdowns update instantly.', dZh: '「自訂選項」按鈕可以管理所有下拉選單。隱藏你用唔著嘅內建預設、刪除你加過嘅自訂選項、或者一鍵顯示所有預設。改完即時更新下拉選單，唔使 reload 頁面。' },
  ...
  var guideSteps = [
    ...
    { icon: '⚙️', t: 'Custom Options', tZh: '自訂選項', d: 'Click "Custom Options" next to Reset All to fine-tune your dropdown lists. Hide presets you don\'t need, or clean up old custom entries. "Show all defaults" restores everything.', dZh: '撳 Reset All 隔籬嘅「自訂選項」可以整理下拉選單。隱藏你用唔著嘅 preset，或者清理舊自訂選項。用「顯示所有預設」一鍵恢復。' },
